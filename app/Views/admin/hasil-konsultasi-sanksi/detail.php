    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <a href="<?= base_url('admin/hasil-konsultasi-sanksi') ?>" class="btn btn-primary btn-sm">Kembali</a>
            </div>
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="status" value="<?= ucwords(str_replace('_',' ',$konsultasi->status)) ?>" readonly/>
                    </div>

                    <div class="form-group mt-4">
                        <label for="nama">Pernyataan Diagnosa yang sesuai dengan kejadian yang dialami!</label>
                        <ul>
                    ...
                    <div class="form-group">
                        <h6>Jenis Sanksi Administratif</h6>
