          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?= base_url('admin/pertanyaan') ?>">Pertanyaan Diagnosa Kekerasan Seksual</a>
                <a class="dropdown-item" href="<?= base_url('admin/pertanyaan-pelanggaran') ?>">Pertanyaan Pelanggaran</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?= base_url('admin/sanksi-administratif') ?>">Sanksi Administratif</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
